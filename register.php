...
require 'C:/xampp/htdocs/htdocs/loginRegistration/vendor/phpmailer/phpmailer/src/Exception.php';
require 'C:/xampp/htdocs/htdocs/loginRegistration/vendor/phpmailer/phpmailer/src/PHPMailer.php';
require 'C:/xampp/htdocs/htdocs/loginRegistration/vendor/phpmailer/phpmailer/src/SMTP.php';
...
function sendemail_verify($username, $email, $verify_token) 
{
    ...
    try {
        ...
        <br/><br/>
        <a href='http://localhost/loginRegistration/verify-email.php?token=$verify_token'>Click here to verify</a>";
...
<body class="bg-[#080914]">
    <div class="flex items-center text-[#E4E2DD] flex-col justify-center h-dvh">
        <div class="border border-black p-12 max-[400px]:p-5 rounded-md justify-center items-center flex flex-col font-worksans bg-[#13141F] leading-snug"> 
            ...
            <form action="" method="POST" class="flex flex-col gap-1 mt-2 w-[18rem]">
                <input type="email" name="email" id="registerEmail" placeholder="Email" required class="p-2 focus:outline-none text-black rounded-md max-[400px]:p-2.5" oninput="validateRegisterEmail()">
                ...
                <input type="text" name="username" id="registerUsername" placeholder="Username" required class="p-2 focus:outline-none text-black rounded-md max-[400px]:p-2.5" oninput="validateRegisterUsername()">
                ...
                <input type="password" name="password" id="registerPassword" placeholder="Password" required class="p-2 focus:outline-none text-black rounded-md max-[400px]:p-2.5" oninput="validateRegisterPassword()">
                <span id="registerPasswordError" class="text-red-600 text-[0.9rem]"></span>
                <span id="registerPasswordSuccess" class="text-green-600 mb-1 text-[0.9rem]"></span>

                <input type="password" name="repassword" id="registerRePassword" placeholder="Re-enter password" required class="p-2 focus:outline-none text-black rounded-md max-[400px]:p-2.5" oninput="validateRegisterRePassword()">
                <span id="registerRePasswordError" class="text-red-600 text-[0.9rem]"></span>
                <span id="registerRePasswordSuccess" class="text-green-600 mb-1 text-[0.9rem]"></span>
