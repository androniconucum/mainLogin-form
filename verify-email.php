            ...
            if ($user['verify_status'] == 0) {
                ...
                if (mysqli_stmt_prepare($update_stmt, $update_query)) {
                    ...
                    if (mysqli_stmt_execute($update_stmt)) {
                        echo "<div class='text-green-500 font-bold'>Your email has been successfully verified. You can now <a href='http://localhost/loginRegistration/login.php'>Login</a></div>";
                    } else {
                        echo "<div class='text-red-500 font-bold'>Verification failed. Please try again later.</div>";
                    }
                }
            } else {
                echo "<div class='text-yellow-500 font-bold'>Your email is already verified. You can <a href='http://localhost/loginRegistration/login.php'>Login</a></div>";
            }
        } else {
