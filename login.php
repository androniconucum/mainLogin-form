    ...
    <div class="flex h-screen items-center text-[#E4E2DD] flex-col justify-center">
        <div class="border border-black p-10 max-[400px]:p-5 rounded-md justify-center items-center flex flex-col font-worksans bg-[#13141F] leading-snug"> 
            ...
            <form method="POST" class="flex flex-col gap-1 mt-2 w-[18rem]">
                <input type="text" name="username" id="loginUsername" placeholder="Username" required class="p-2 focus:outline-none text-black rounded-md max-[400px]:p-2.5" >
                ...
                <input type="password" name="password" id="loginPassword" placeholder="Password" required class="p-2 focus:outline-none text-black rounded-md max-[400px]:p-2.5">
